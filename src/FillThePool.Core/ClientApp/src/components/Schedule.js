...
class Schedule extends React.Component {
	...
	getLessonForDate = (date) => {
		...
		if (scheduleData.lessons) {
			const lessons = scheduleData.lessons.filter((l) => {
				...
				if (this.state.lessonSort === 'instructor') {
					...
					return this.props.sortDirection === 'asc' ? a.instructor.name > b.instructor.name ? 1 : -1 : a.instructor.name < b.instructor.name ? 1: -1;
				}
				else {
					if (a.time === b.time) {
						return 0;
					}
					return this.props.sortDirection === 'asc' ? a.time > b.time ? 1 : -1 : a.time < b.time ? 1 : -1;
				}
			});
			return lessons;
		}
	...
	handleRequestSort = (event, property) => {
		...
		if (this.state.lessonSort === property && this.state.sortDirection === 'desc') {
			sortDirection = 'asc';
		}
						...
						<div className={classes.root}>
							<Stepper activeStep={activeStep} orientation="vertical">
								...
								<Step>
									...
									<StepContent>
										<LessonStep validationMessage={this.state.messages}
											...
											students={this.getStudents()} {...stepProps} />
									</StepContent>
								</Step>
								<Step>
