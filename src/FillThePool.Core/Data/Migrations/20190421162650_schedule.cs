        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Registrations_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Pools_PoolId",
                        column: x => x.PoolId,
                        principalTable: "Pools",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_Registrations_RegistrationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_CreatedById",
                table: "Registrations",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_RegistrationId",
                table: "Schedules",
